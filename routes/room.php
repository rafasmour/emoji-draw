...
Route::prefix('room')->middleware('auth')->group(function () {
    Route::get('/', [GetRoomsController::class])->name('room.rooms');
    Route::post('create', [CreateRoomController::class])->name('room.create');
    ...
    Route::prefix('{room}')->middleware(EnsureUserInRoom::class)->group(function () {
        Route::get('/', [RoomLobbyController::class])->name('room.lobby');
        Route::get('game', [GameViewController::class])->name('room.game');
